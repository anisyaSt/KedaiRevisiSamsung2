<?php
session_start();
$_SESSION['namabarang'] = "IPHONE 6 - Rp 2.600.000,-";//session yang akan didaftarkan
  ...
  <body>
    ...
    <table width="90%" align=center >
      <tr>
        ...
        <div class="gambarr">
          <div class="gambarhp">
         <img id="myImg" src="produk/ip6/apple-iphone-6-4.jpg" height="300px"> <br>
					</div>
          ...
          <div class="harga">
            <strong>IPHONE 6</strong> <br>Rp 2.600.000,- <br>
          </div>
        ...
        <td>
          ...
          <table  width="100%" class="t01" style="font-size:19px;">
            ...
            <caption><strong style="font-size:30px;">Spesifikasi IPHONE 6</strong></caption>
            <tr>
              <th>HARGA</th>
              <td>Rp 2 jutaan</td>
            </tr>
...
<div id="Tokyo" class="tabcontent" style="font-family:'Sintony', sans-serif">
  ...
  <div class="gambargaleri" align="center">
    ...
    <img src="galeri/IP6/1.png" >
    <img src="galeri/IP6/2.png" >
    <img src="galeri/IP6/3.png" >
		<img src="galeri/IP6/5.png" >
  </div>
</div>
