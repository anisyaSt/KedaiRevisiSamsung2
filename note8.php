<?php
session_start();
$_SESSION['namabarang'] = "SAMSUNG GALAXY NOTE 8 - Rp 13.000.000,-";//session yang akan didaftarkan
    ...
    <table width="90%" align=center >
      <tr>
        ...
        <div class="gambarr">
		  ...
		  <img id="myImg" src="produk/n8/n8.png" height="300px"> <br>
					</div>
          ...
          <div class="harga">
            <strong>SAMSUNG GALAXY NOTE 8</strong> <br>Rp 13.000.000,- <br>
          </div>

          <div class="order" style="padding-left:16px;">
            <br>
        ...
        <td>
          ...
          <table  width="100%" class="t01" style="font-size:19px;">
            ...
            <caption><strong style="font-size:30px;">Spesifikasi Samsung Galaxy NOTE 8</strong></caption>
            <tr>
              <th>HARGA</th>
              <td>Rp13 juta</td>
            </tr>
            <tr>
              <th>STATUS</th>
              <td>Sudah dirilis (Agustus 2017)</td>
            </tr>
            <tr>
              <th>BODY</th>
  ...
  <table class="t01">
			...
			<tr>
              ...
              <td  style="background-color:white;"><br></td>
				...
				<td>
					<table>
						<tr>
							<td>162.5 x 74.8 x 8.6 mm (6.40 x 2.94 x 0.34 in)</td>
						</tr>
						<tr>
							<td>195 g (6.88 oz)</td>
						</tr>
						...
						<tr>
							<td  style="background-color:white;">Single SIM (Nano-SIM) or Hybrid Dual SIM (Nano-SIM, dual stand-by)</td>
						</tr>
						<tr>
							<td  style="background-color:white;">- Samsung Pay (Visa, MasterCard certified)</td>
						</tr>
						<tr>
							<td  style="background-color:white;">- IP68 certified - dust/water proof (up to 1.5m for 30 mins)</td>
						</tr>
						<tr>
							<td  style="background-color:white;">- Stylus</td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td>
					<table>
						...
						<tr>
							<td>6.3 inches, 101.1 cm2 (~83.2% screen-to-body ratio)</td>
						</tr>
						<tr>
							<td>1440 x 2960 pixels, 18.5:9 ratio (~521 ppi density)</td>
						</tr>
						<tr>
							<td>Yes</td>
						</tr>
						<tr>
							<td  style="background-color:#d5ebff;">Corning Gorilla Glass 5</td>
						</tr>
						<tr>
							<td  style="background-color:#d5ebff;">- HDR10 compliant</td>
						</tr>
						<tr>
							<td  style="background-color:#d5ebff;">- 3D Touch (home button only)</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td style="background-color:white;">Android 7.1.1 (Nougat), upgradable to Android 8.0 (Oreo)</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td>Dual: 12 MP (f/1.7, 26mm, 1/2.5", 1.4 µm, Dual Pixel PDAF) + 12MP (f/2.4, 52mm, 1/3.6", 1 µm, AF), OIS</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table>
						...
						<tr>
							<td style="background-color:#d5ebff;">3.5 mm jack</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;"><br></td>
						</tr>
				...
				<td>
					<table>
						...
						<tr>
							<td style="background-color:#d5ebff;">Yes</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table>
						...
						<tr>
							<td style="background-color:#d5ebff;">- Fast battery charging (Quick Charge 2.0)</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- Qi/PMA wireless charging (market dependent)</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- ANT+ support</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- Bixby natural language commands and dictation</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- MP4/DivX/XviD/H.265 player</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- MP3/WAV/eAAC+/FLAC player</td>
						</tr>
						<tr>
							<td style="background-color:#d5ebff;">- Photo/video editor</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td>Non-removable Li-Ion 3300 mAh battery</td>
						</tr>
						<tr>
							<td>Up to 22 h (3G)</td>
						</tr>
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td>Midnight Black, Maple Gold, Orchid Gray, Deep Sea Blue, Star Pink (Taiwan only)</td>
						</tr>
						<tr>
							<td>About 750 EUR</td>
						</tr>
			...
			<tr>
				...
				<td>
					<table>
						<tr>
							<td>Basemark OS II: 3374 / Basemark OS II 2.0: 3333 Basemark X: 40890</td>
						</tr>
						<tr>
							<td>Contrast ratio: Infinite (nominal), 4.148(sunlight)</td>
						</tr>
						<tr>
							<td>Photo / Video</td>
						</tr>
						<tr>
							<td>Voice 67dB / Noise 69dB / Ring 71dB</td>
						</tr>
						<tr>
							<td>Noise -92.5dB / Crosstalk -93.2dB</td>
						</tr>
						<tr>
...
<div id="Tokyo" class="tabcontent" style="font-family:'Sintony', sans-serif">
  ...
  <div class="gambargaleri" align="center">
    ...
    <img src="galeri/SGN8/1.jpg" >
    <img src="galeri/SGN8/2.jpg" >
    <img src="galeri/SGN8/3.jpg" >
    <img src="galeri/SGN8/4.jpg" >
    <img src="galeri/SGN8/5.jpg" >
  </div>
</div>
