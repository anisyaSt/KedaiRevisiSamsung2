...
<html>
 ...
 <center>
 <h2>Kritik & Saran</h2>
 Sampaikan Keluhan, Kritik dan Saran Anda untuk Kami</br>Beritahu kami jika anda tidak puas dengan pelayanan kami
 </br>
 <div class="login-card1">
 <center>
 <form action="proseskritik.php" method="post">
	<form action="" method="post">
		<textarea rows="10" cols="70" input name="kritik" input type="text" placeholder="Apa Keluhan Anda?"></textarea>
		<input type="submit" class="button" name="submit" value="Sampaikan">
	</form>
</center>
</div>
<center>
